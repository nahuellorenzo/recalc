...
- Se agregó test e2e para cuando se realiza una potencia mayor a 100000
- Se agregó test e2e para la división por cero

## [1.3.3] 20-06-2023

### Added 

- Se agregó botón de pow
- Se agregó función y botón de binary
- Se realizó conexiones del front con la API
- Se agregó el botón de raiz
- Se agregaron test e2e

### Fixed

- Se solucionaron los errores de los test estáticos
- Se solucionó bug del botón igual
- Se solucionó bug del botón C
- Se solucionó bug para restar números negativos
...
[unreleased]: https://github.com/frlp-utn-ingsoft/recalc/compare/v1.3.4...HEAD
[1.3.4]: https://github.com/frlp-utn-ingsoft/recalc/releases/tag/v1.3.4
[1.3.3]: https://github.com/frlp-utn-ingsoft/recalc/releases/tag/v1.3.3
